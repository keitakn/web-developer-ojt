...
### とりあえず早くリリースするという考え方について

「品質とスピードはトレード・オフの関係にある」という主張をする人がいます。

しかしこれは誤りだと私は考えています。

設計の基本を知っている、キレイなコードの書き方を知っている、という事が全てになります。

キレイに書いたら遅くなる、汚く書いたら早くなるという訳ではありません。

品質の高いプロダクトをそれなりの速度で作れるようになる為には設計手法を学ぶ事が必要不可欠です。

（参考） http://kobase16.hatenablog.com/entry/2019/10/31/230509

## 終わりに

以上が設計に関する基本的な心構えになります。

同階層のページに各分野での設計方法を記載した資料を作成しますので参考にしてみて下さい。
