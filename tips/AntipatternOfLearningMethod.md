...
軍隊というのは上の命令が絶対のような世界ですし、マニュアル化された単純作業を行うだけの人を量産する事には日本の教育は適していると言えます。
...
これは定年まで同じ働くから社内の人間関係が最も重要であるという前提の考えに成り立っています。
...
オープンソースの世界では、使いにくいライブラリは淘汰されていくし、逆に使いやすいライブラリであればGitHubのスター数やダウンロード数は伸びていきます。
